...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    eventImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    eventsPhotos: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    isActive: Schema.Attribute.Boolean;
...
export interface ApiMediaItemMediaItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
    type: Schema.Attribute.Enumeration<['soundcloud', 'youtube']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMediaPlayerMediaPlayer extends Struct.CollectionTypeSchema {
  collectionName: 'media_players';
  info: {
    displayName: 'Media Player';
    pluralName: 'media-players';
    singularName: 'media-player';
  };
  options: {
    draftAndPublish: true;
  };
